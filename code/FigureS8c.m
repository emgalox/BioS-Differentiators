...
[t,y]=ode23s(@sol,tspace,[1.1701;19.9990;0;0;0;0;0;  1.2034]);


function dydt=sol(t,y)
dydt(1,1)=900*y(2)/(880+y(2))-14.18*y(1)*y(8)-0.028*y(1);                                  
...
dydt(7,1)=4*y(3)- y(7);
dydt(8,1)=20-14.18*y(1)*y(8)-0.028*y(8);
end
end