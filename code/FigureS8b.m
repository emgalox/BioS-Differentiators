...
[t,y]=ode23s(@sol,tspace,[2.0202;100;1.6500;76.9468;1.6872;1.3171;0;0;0;0;0]);


function dydt=sol(t,y)
dydt(1,1)=1*y(2)- 30*y(1)*y(3);                                  
dydt(2,1)=-1*y(2)*y(1)+ 1.5*y(4)*y(6) + 100 +(y(11))*100 - 0.5*y(2);
dydt(3,1)=100-30*y(1)*y(3);
dydt(4,1)=-1.25*y(4)*y(1)+ 1.5*y(4)*y(6) +100 + (y(11))*100 - 0.75*y(4); 
dydt(5,1)=1*y(2)-45*y(5)*y(6);
dydt(6,1)=100-45*y(5)*y(6);
dydt(7,1)=2*y(9)- y(7);
dydt(8,1)=4*y(7)- y(8);
