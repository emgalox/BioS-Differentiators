...
tspace=linspace(0,80,1000);

[t,y]=ode23s(@sol,tspace,[9.535;10;0;0;0;0;0;0.035]);


function dydt=sol(t,y)
dydt(1,1)=1*y(2)-30*y(1)*y(8);                                  
dydt(2,1)=-1*y(2)*y(1)+1*y(2)*y(8) +100 + (y(7))*10 - 0.5*y(2);       
dydt(3,1)=2*y(5)- y(3);
dydt(4,1)=4*y(3)- y(4);
dydt(5,1)=2-12*y(5)*y(6);
dydt(6,1)=2*y(4)-12*y(5)*y(6);
dydt(7,1)=4*y(3)- y(7);
dydt(8,1)=10-30*y(1)*y(8);
end
end