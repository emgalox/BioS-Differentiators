...
[t,y]=ode23s(@sol,tspace,[9.5;10;0;0.00035088;]);


function dydt=sol(t,y)
dydt(1,1)=1*y(2)- 3000*y(1)*y(4);                                  
dydt(2,1)=-1*y(2)*y(1) +100 + (y(3))*10 - 0.5*y(2);       
dydt(3,1)=0.1 - 0.0001*y(3);
dydt(4,1)=10- 3000*y(1)*y(4);
end
end