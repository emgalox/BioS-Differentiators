...
[t,y]=ode23s(@sol,tspace,[ 0.9957;20.2717;0;0;0;0;0;0.0472]);


function dydt=sol(t,y)
dydt(1,1)=900*y(2)/(880+y(2))-425*y(1)*y(8)-0.28*y(1);                                  
dydt(2,1)=-1.6*y(2)*y(1) +40 + (y(7))*1.6*20 - (0.1+0.28)*y(2);       
dydt(3,1)=2*y(5)- y(3);
dydt(4,1)=4*y(3)- y(4);
dydt(5,1)=2-12*y(5)*y(6);
dydt(6,1)=2*y(4)-12*y(5)*y(6);
dydt(7,1)=4*y(3)- y(7);
dydt(8,1)=20-425*y(1)*y(8)-0.28*y(8);
end
end